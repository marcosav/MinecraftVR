...
public class TerrainPersistor : MonoBehaviour
{
    ...
    private string GetChunkFile(ChunkPos pos) => String.Format("chunk{0}-{1}.data", pos.x, pos.z);

    public BlockDistribution GetBlocksFor(ChunkPos pos, Function<ChunkPos, BlockDistribution> Generator)
    {
    ...
    public void SaveChunk(ChunkPos pos, BlockDistribution blocks)
    {
        if (blocks == null)
